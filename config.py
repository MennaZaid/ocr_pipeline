...
AIN_PROMPT = """اقرأ هذه الصورة بعناية وانسخ كل النص المكتوب فيها، كلمة كلمة، كما تراه بالضبط.

اكتب النص فقط كفقرات عادية. لا تستخدم صيغة JSON، ولا أقواس معقوفة {}, ولا أقواس مربعة []، ولا أي تنسيق أو تلخيص من أي نوع. فقط انسخ الكلام كما هو مكتوب في الصورة، سطراً بعد سطر.

إذا كان جزء من النص غير واضح، اكتب "؟" في مكانه بدلاً من التخمين.
"""
